...
const allowed=new Set(['snapshot','add-profile','rename-profile','toggle-profile','login','scan','settings','connect-notion','retry','open-notion','refresh-sheet','open-sheet','clear-notion']);
