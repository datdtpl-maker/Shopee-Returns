...
const allowed=new Set(['snapshot','products-scan','products-load','products-sync','products-edit','products-edit-batch','products-stop-batch','products-notion','import-config','open-data','add-profile','rename-profile','toggle-profile','login','scan','settings','connect-notion','retry','open-notion','refresh-sheet','open-sheet','clear-notion']);
